...
class Income < ApplicationRecord
  ...
  delegate :payment_method_id,   to: :income_resourcable
  delegate :payment_method_name, to: :income_resourcable
  delegate :payment_type_id,     to: :income_resourcable
  delegate :payment_type_name,   to: :income_resourcable
