...
module Coaching
  class GroupsController < Coaching::HomeController
    ...
    def import
      ::Importers::GroupImportService.call(params[:file], current_account, current_user)
      redirect_to coaching_groups_path, flash: { success: t("flash_messages.imported", name: "Groups") }
    end
